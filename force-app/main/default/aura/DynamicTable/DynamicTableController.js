({
    ...
    initializeComponent : function(component, event, helper) {
        ...
        component.set('v.SelectedRecordsMap', new Map());
       	component.set("v.FieldNames", $A.util.isEmpty(component.get("v.FieldNamesUI")) ? ["Id"] : component.get("v.FieldNamesUI").split(","));
        component.set("v.FieldLabels", $A.util.isEmpty(component.get("v.FieldLabelsUI")) ? [] : component.get("v.FieldLabelsUI").split(","));
