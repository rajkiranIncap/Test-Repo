...
({
    ...
    handleApplicationEvent : function(component, event, helper){
        //below logic needs to be implemented for all the lightning component to 
        //validate againts repeater vs indivisual component.
        var applySkipLogic = true;
        if(event.getParam("fieldValueObject") && event.getParam("fieldValueObject").cardIndex && component.get("v.indexVal")){
            if(event.getParam("fieldValueObject").cardIndex !== component.get("v.indexVal") ){
                applySkipLogic = false;
            }
        }
        //End
        if(applySkipLogic){
