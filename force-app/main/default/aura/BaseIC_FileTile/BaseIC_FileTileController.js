({
    ...
    handleDelete: function (component, event, helper) {
        try {
            ...
            console.error('Error in component- BaseIC_FileTile, jscontroller, method- handleDelete');
            console.error(jex);
        }
    },
    previewRequest: function (component, event, helper) {
        try {
            ...
            console.error('Error in component- BaseIC_FileTile, jscontroller, method- doInIt');
            console.error(jex);
        }
    },
    colseModal: function (component, event, helper) {
        try {
            ...
            console.error('Error in component- BaseIC_FileTile, jscontroller, method- colseModal');
            console.error(jex);
        }
    },
    handleOnLoad: function (component, event, helper) {
        try {
            ...
            console.error('Error in component- BaseIC_FileTile, jscontroller, method- handleOnLoad');
            console.error(jex);
        }
    },
    handleOnError: function (component, event, helper) {
        try {
            ...
            console.error('Error in component- BaseIC_FileTile, jscontroller, method- handleOnError');
            console.error(jex);
        }
    },
    handleThumbLoad: function (component, event, helper) {
        try {
            ...
            console.error('Error in component- BaseIC_FileTile, jscontroller, method- handleThumbLoad');
            console.error(jex);
        }
    },
