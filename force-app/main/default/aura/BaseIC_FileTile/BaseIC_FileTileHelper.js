({
    ...
    handleDelete: function (component, event) {
        try {
            ...
            console.error('Error in component- BaseIC_FileTile, jsHelper, method- handleDelete');
            console.error(jex);
        }
    },
    ...
    sortSelectedFiles: function (component, event) {
        try {
            ...
            console.error('Error in component- BaseIC_FileTile, jsHelper, method- sortSelectedFiles');
            console.error(jex);
        }
    },
    previewRequest: function (component, event) {
        try {
            ...
            console.error('Error in component- BaseIC_SaveAttachmentComp, jsHelper, method- previewRequest');
            console.error(jex);
        }
    },
})