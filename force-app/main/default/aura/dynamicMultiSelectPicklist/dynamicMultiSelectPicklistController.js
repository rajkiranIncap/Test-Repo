({
     init : function(component, event, helper) {
        var params = { fld: component.get("v.fieldBinding"), obj: component.get("v.mssobject")}
        var action = component.get("c.getPicklistValues");
        action.setParams(params);
    	action.setCallback(this, function (a) {
              if (a.getState() === 'ERROR') {
                helper.handleErrorsToast(a.getError())
              } else if (a.getState() === 'SUCCESS') {
                  component.set("v.msoptions", a.getReturnValue());
              }
        });
